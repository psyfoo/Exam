...
{
extract($_POST);
mysql_query("insert into question(testid,quedsc,ans1,ans2,ans3,ans4,trueans) values ('$testid','$quedsc','$ans1','$ans2','$ans3','$ans4','$trueans')",$cn) or die(mysql_error());
...
<?php
$rs=mysql_query("Select * from test order by testname",$cn);
...
?>
    ...
    <tr>
        ...
        <td>&nbsp;</td>
	    <td><textarea name="quedsc" cols="60" rows="2" id="addque"></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><input name="trueans" type="text" id="anstrue" size="50" maxlength="50"></td>
    </tr>
    <tr>
      <td height="26"></td>
      <td>&nbsp;</td>
